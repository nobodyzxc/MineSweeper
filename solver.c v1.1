...
//			if(reason_array[14][23] == 9 && reason_array[14][26] == 9 && reason_array[15][23] == 9 && reason_array[15][24] == 10){
//				puts("all complete");
//				print_array("reason_array");
...
//					getchar();
//					if(i == 15 && j == 26){
//						printf(" %d >= %f ??\n" , All_count(0 , reason_array) - 1 , dfs_flags);
//						getchar();
//					}
//					else
//						printf("%d \n" , border[i][j]);
...
//						if(reason_array[14][23] == 9 && reason_array[14][26] == 9 && reason_array[15][23] == 9 && reason_array[15][24] == 10){
//							printf("now suppose %d %d is 10\n" , i , j);
//							printf("all complete result is %d\n" , result);
//							getchar();
//						}
